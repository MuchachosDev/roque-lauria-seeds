...
class SeedArrivalOrder(models.Model):
    ...
    company_id = fields.Many2one(
        string="Empresa", comodel_name="seed.company", related="hibrid_id.company_id"
    )
    vegetable = fields.Many2one(
        string="Hortaliza",
    ...
    # Detalle tecnico
    fruit_shape = fields.Char(string="Forma de la fruta")
    thorn = fields.Boolean(string="Espinas")
    fruit_color = fields.Char(string="Color de la fruta o cabeza")
    avg_weigh = fields.Decimal(string="Peso promedio del fruto", digits=(6, 2))
    core_color = fields.Char(string="Color de la pulpa")
    peel_color = fields.Char(string="Color de la cascara en maduración")
    ...
    brix_degrees = fields.Decimal(string="Grados Brixs", digits=(4, 2))
    ...
    resistance = fields.Char(string="Resistencia")
